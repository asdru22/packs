...
execute if data storage mach:storage root.temp.gui[{Slot:11b}] if data storage mach:storage root.temp.gui[{Slot:13b}] if data storage mach:storage root.temp.gui[{Slot:15b}] run function mach:block/converger/ugly_fix

function mach:block/converger/slots
