...
execute if score $i1 mach.data matches 1.. if score $i2 mach.data matches 4.. if score $i3 mach.data matches 1.. run function mach:block/machine_assembler/assemble/take_item/converger_give
