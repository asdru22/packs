scoreboard players set .id asy.data 1
...
execute if score @s asy.symbiote < @s asy.max_symbiote run clear @s warped_fungus_on_a_stick{asy:{VialEntity:"asy:scraper"}} 1