import json
root = "C:/Users/Ale/Documents/GitHub/asdrus-artefacts/"
write_to = "C:/Users/Ale/Documents/GitHub/asdrus-artefacts/datapack/data/aar/functions/recipes/shaped.mcfunction"
            ...
            if not row == []:
                ...
                for item in row:
                    if item =="":
                        ...
                        out += "{Slot:"+str(slot)+"b,tag:{aar:{id:\""+item[4:]+"\"}}}"
                    slot +=1
                    if not slot == 3: out +=","
                out += "],"
            col += 1
