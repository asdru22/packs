...
execute as @e[type=minecraft:item_display,tag=haywire.prevents_hoppers,tag=haywire.block,distance=..5] at @s positioned ~ ~-1 ~ run function haywire:block/hopper_updating/fill