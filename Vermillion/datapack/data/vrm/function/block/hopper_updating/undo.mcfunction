...
execute as @e[type=minecraft:item_display,tag=vrm.prevents_hoppers,tag=vrm.block,distance=..5] at @s positioned ~ ~-1 ~ run function vrm:block/hopper_updating/fill