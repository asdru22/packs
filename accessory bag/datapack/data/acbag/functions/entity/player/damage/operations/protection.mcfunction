...
execute store result score acbag.temp_0 acbag.dummy run data get entity @s Inventory[{Slot:103b}].tag.Enchantments[{id:"minecraft:protection"}].lvl
scoreboard players operation acbag.temp_1 acbag.dummy = acbag.temp_0 acbag.dummy
execute store result score acbag.temp_0 acbag.dummy run data get entity @s Inventory[{Slot:102b}].tag.Enchantments[{id:"minecraft:protection"}].lvl
scoreboard players operation acbag.temp_1 acbag.dummy += acbag.temp_0 acbag.dummy
execute store result score acbag.temp_0 acbag.dummy run data get entity @s Inventory[{Slot:101b}].tag.Enchantments[{id:"minecraft:protection"}].lvl
scoreboard players operation acbag.temp_1 acbag.dummy += acbag.temp_0 acbag.dummy
execute store result score acbag.temp_0 acbag.dummy run data get entity @s Inventory[{Slot:100b}].tag.Enchantments[{id:"minecraft:protection"}].lvl
scoreboard players operation acbag.temp_1 acbag.dummy += acbag.temp_0 acbag.dummy
