...
data modify storage dsl:storage root.temp.item.tag.display.Lore prepend value '{"color":"blue","italic":false,"translate":"potion.withDuration","with":[{"translate":"effect.minecraft.strength"},{"translate":"potion.dsl.duration","with":[0,0,1,8]}]}'
...
data modify storage dsl:storage root.temp.item.tag.display.Lore append value '{"color":"blue","italic":false,"translate":"attribute.modifier.plus.0","with":[3,{"translate":"attribute.name.generic.attack_damage"}]}'
