...
data modify storage dsl:storage root.temp.item.tag.display.Lore prepend value '{"color":"blue","italic":false,"translate":"potion.withDuration","with":[{"translate":"effect.minecraft.jump_boost"},{"translate":"potion.dsl.duration","with":[0,0,1,8]}]}'
